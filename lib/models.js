...
var BaseModel = exports.BaseModel = function (_Backbone$Model) {
  ...
  _createClass(BaseModel, [{
    ...
    value: function sync(method, model, options) {
      return (0, _backbone3.backboneSync)(method, model, options);
    }
  }, {
    key: 'url',
    value: function url() {
      var baseUrl = _get(BaseModel.prototype.__proto__ || Object.getPrototypeOf(BaseModel.prototype), 'url', this).call(this);
      if (!baseUrl.match(/\/$/)) {
        return baseUrl + '/';
      }
      return baseUrl;
